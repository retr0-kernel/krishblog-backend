...
func (_q *MediaAssetQuery) QueryUploader() *UserQuery {
...
func (_q *MediaAssetQuery) WithUploader(opts ...func(*UserQuery)) *MediaAssetQuery {
	query := (&UserClient{config: _q.config}).Query()
...
//		GroupBy(mediaasset.FieldUploaderID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.MediaAsset.Query().
//		Select(mediaasset.FieldUploaderID).
//		Scan(ctx, &v)
...
func (_q *MediaAssetQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*MediaAsset, error) {
	...
	if query := _q.withUploader; query != nil {
		if err := _q.loadUploader(ctx, query, nodes, nil,
			func(n *MediaAsset, e *User) { n.Edges.Uploader = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *MediaAssetQuery) loadUploader(ctx context.Context, query *UserQuery, nodes []*MediaAsset, init func(*MediaAsset), assign func(*MediaAsset, *User)) error {
...
func (_q *MediaAssetQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withUploader != nil {
			_spec.Node.AddColumnOnce(mediaasset.FieldUploaderID)
		}
	}
